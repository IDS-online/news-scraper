...
## Naming Convention
`NEWS-X-feature-name.md`

Beispiele:
- `NEWS-1-user-authentication.md`
- `NEWS-2-kanban-board.md`
- `NEWS-3-file-attachments.md`
...
- `git log --grep="NEWS-1"` zeigt alle Änderungen für dieses Feature
