# PROJ-3: RSS/Atom Feed Scraping Engine
...
## Dependencies
- Requires: PROJ-2 (News-Quellen-Verwaltung) — Quellen mit Typ "RSS" müssen existieren

## Overview
Eine serverseitige Engine, die RSS 2.0 und Atom 1.0 Feeds von konfigurierten Quellen abruft und die Artikel in ein einheitliches internes Format normalisiert. Die Engine gibt eine Liste normalisierter Artikel zurück — das Speichern übernimmt PROJ-5 (Scheduler & Deduplizierung).
...
## Out of Scope
- HTML-Seiten scrapen (das ist PROJ-4)
- Artikel in die Datenbank speichern (das ist PROJ-5)
