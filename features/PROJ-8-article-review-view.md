# PROJ-8: Artikel-Review-Ansicht (Quellen-Detail & Verwaltung)
...
## Dependencies
- Requires: PROJ-1 (User Authentication) — eingeloggte User / Admin-Rolle
- Requires: PROJ-2 (News-Quellen-Verwaltung) — Quellen-Liste als Einstiegspunkt
- Requires: PROJ-5 (Scraping Scheduler) — Artikel müssen in der DB vorhanden sein
- Requires: PROJ-6 (News REST API) — Artikel und Quellen werden über die API geladen
...
## Abgrenzung zu PROJ-7

| Aspekt | PROJ-7 (News Dashboard) | PROJ-8 (Artikel-Review) |
|--------|------------------------|------------------------|
