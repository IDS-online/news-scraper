# PROJ-5: Scraping Scheduler & Deduplizierung
...
## Dependencies
- Requires: PROJ-2 (News-Quellen-Verwaltung) — aktive Quellen mit Intervall-Konfiguration
- Requires: PROJ-3 (RSS Scraping Engine) — für RSS-Quellen
- Requires: PROJ-4 (HTML DOM Scraping Engine) — für HTML-Quellen
